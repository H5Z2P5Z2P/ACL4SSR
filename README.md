...
----              | ----  |  ----  | ----  |   ----     |     ----     |    ----
[banAD.acl](https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Acl/banAD.acl)         |  代理  |   是   |  直连  |    有-直连  | 常用域名-直连  |  代理-常用国外域名增强
[onlybanAD.acl](https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Acl/onlybanAD.acl)     |  代理  |   是   |  直连  |    无      |    无         |  代理-常用国外域名增强
[nobanAD.acl](https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Acl/nobanAD.acl)       |  代理  |   否   |  直连  |    有-直连  |  常用域名-直连 |  全局代理
[backcn-banAD.acl](https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Acl/backcn-banAD.acl)  |  代理  |   是   |  直连  |    有-代理  |    无         | 直连-gfwlist列表 
[gfwlist-banAD.acl](https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Acl/gfwlist-banAD.acl) |  直连  |   是   |  直连  |    无      |    无         |  代理-gfwlist列表
[fullgfwlist.acl](https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Acl/fullgfwlist.acl )   |  直连  |   否   |  直连  |    无      |    无         |  代理-gfwlist列表
[gfwlist-user.rule](https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/Acl/gfwlist-user.rule) |  直连  |   是   |  直连  |    无      |     无        |  代理-gfwlist列表
...
* ACL更新地址（**白名单**）：https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/banAD.acl
* ACL更新地址（**黑名单**）：https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/gfwlist-banAD.acl
* ACL更新地址（**全局**）：https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/onlybanAD.acl
* ACL更新地址（**仅GFWList**）：https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/fullgfwlist.acl （原版SS**能且仅能**使用此规则）
* ACL更新地址（**国内代理**）：https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/backcn-banAD.acl
* ACL更新地址（**白名单，无去广告**）：https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/nobanAD.acl
* SSR C# GFWList user.rule ：https://cdn.jsdelivr.net/gh/ACL4SSR/ACL4SSR@master/gfwlist-user.rule
